...
@Entity(tableName = "ai_tts_model", comment = "TTS模型配置表", pk_constraint = "PRIMARY")
public class AiTtsModel implements Serializable {
    ...
    @Column(name = "default_voice", comment = "默认音色", length = 50L, defaultValue = "alloy", type = java.sql.Types.VARCHAR, nullable = true)
    ...
    public AiTtsModel(BigInteger id) {
        this.id = id;
    }
}
