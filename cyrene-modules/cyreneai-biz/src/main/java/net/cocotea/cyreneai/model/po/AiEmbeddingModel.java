...
@Entity(tableName = "ai_embedding_model", comment = "嵌入模型配置表", pk_constraint = "PRIMARY")
public class AiEmbeddingModel implements Serializable {
    ...
    @Column(name = "dimension", comment = "向量维度", length = 10L, type = java.sql.Types.INTEGER, nullable = true)
    ...
    public AiEmbeddingModel() {}

    public AiEmbeddingModel(BigInteger id) {
        this.id = id;
    }
}
