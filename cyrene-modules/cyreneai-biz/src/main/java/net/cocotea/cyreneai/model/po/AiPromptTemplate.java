...
@Entity(tableName = "ai_prompt_template", comment = "AI提示词模板表", pk_constraint = "PRIMARY")
public class AiPromptTemplate implements Serializable {
    ...
    @Column(name = "name", comment = "模板名称", length = 200L, type = java.sql.Types.VARCHAR, nullable = false)
    private String name;

    @Column(name = "description", comment = "模板描述", length = 500L, type = java.sql.Types.VARCHAR, nullable = true)
    private String description;

    @Column(name = "category", comment = "分类", length = 50L, type = java.sql.Types.VARCHAR, nullable = true)
    private String category;

    @Column(name = "scene", comment = "适用场景;system, user, mixed", length = 20L, defaultValue = "system", type = java.sql.Types.VARCHAR, nullable = true)
    private String scene;

    @Column(name = "content", comment = "模板内容", length = 65535L, type = java.sql.Types.VARCHAR, nullable = false)
    private String content;

    @Column(name = "variables", comment = "变量列表(JSON)", length = 65535L, type = java.sql.Types.VARCHAR, nullable = true)
    private String variables;

    @Column(name = "current_version", comment = "当前版本号", length = 10L, defaultValue = "1", type = java.sql.Types.INTEGER, nullable = true)
    ...
    public AiPromptTemplate(BigInteger id) {
        this.id = id;
    }
}
