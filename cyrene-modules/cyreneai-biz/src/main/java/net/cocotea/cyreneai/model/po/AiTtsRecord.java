...
@Entity(tableName = "ai_tts_record", comment = "TTS生成记录表", pk_constraint = "PRIMARY")
public class AiTtsRecord implements Serializable {
    ...
    @Column(name = "text", comment = "合成文本", length = 4000L, type = java.sql.Types.VARCHAR, nullable = false)
    private String text;

    @Column(name = "model_name", comment = "模型名称", length = 100L, type = java.sql.Types.VARCHAR, nullable = false)
    private String modelName;

    @Column(name = "voice", comment = "音色", length = 50L, type = java.sql.Types.VARCHAR, nullable = true)
    private String voice;

    @Column(name = "audio_url", comment = "音频URL", length = 1024L, type = java.sql.Types.VARCHAR, nullable = true)
    private String audioUrl;

    @Column(name = "file_size", comment = "文件大小(字节)", length = 19L, type = java.sql.Types.BIGINT, nullable = true)
    private BigInteger fileSize;

    @Column(name = "duration_seconds", comment = "时长(秒)", length = 10L, type = java.sql.Types.INTEGER, nullable = true)
    ...
    public AiTtsRecord(BigInteger id) {
        this.id = id;
    }
}
