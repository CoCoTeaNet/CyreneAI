...
@Entity(tableName = "ai_image_model", comment = "图片模型配置表", pk_constraint = "PRIMARY")
public class AiImageModel implements Serializable {
    ...
    @Column(name = "default_size", comment = "默认尺寸", length = 20L, defaultValue = "1024x1024", type = java.sql.Types.VARCHAR, nullable = true)
    ...
    public AiImageModel(BigInteger id) {
        this.id = id;
    }
}
